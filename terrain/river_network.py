### stolen from https://github.com/dandrino/terrain-erosion-3-ways/blob/master/river_network.py

#!/usr/bin/python3

import sys
sys.path.append("C:/Users/jlbuc/my_python/repos/blender_architecture/terrain")
import importlib
